...
export const MODEL_CATALOG: readonly ModelCatalogEntry[] = Object.freeze([
  ...
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-sonnet-4"),
    outputLimit: 64000,
    modalities: PDF_MODALITIES,
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-sonnet-4-5"),
    outputLimit: 64000,
    modalities: PDF_MODALITIES,
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-sonnet-4-6"),
    outputLimit: 64000,
    modalities: PDF_MODALITIES,
  },
  {
  ...
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-sonnet-5"),
    outputLimit: 64000,
    modalities: PDF_MODALITIES,
  },
  {
  ...
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-haiku-4-5"),
    outputLimit: 64000,
    modalities: IMAGE_MODALITIES,
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-opus-4-5"),
    outputLimit: 64000,
    modalities: PDF_MODALITIES,
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-opus-4-6"),
    outputLimit: 64000,
    modalities: PDF_MODALITIES,
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-opus-4-7"),
    outputLimit: 128000,
    modalities: PDF_MODALITIES,
  },
  {
  ...
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-opus-4-8"),
    outputLimit: 128000,
    modalities: PDF_MODALITIES,
  },
  {
  ...
  },
  {
    ...
    contextLimit: getModelContextLimit("claude-opus-5"),
    outputLimit: 128000,
    modalities: PDF_MODALITIES,
  },
  {
  ...
  },
  {
    ...
    name: "Claude Opus 5.5 (2.0x)",
    contextLimit: getModelContextLimit("claude-opus-5-5"),
    outputLimit: 128000,
    rateMultiplier: 2,
    modalities: PDF_MODALITIES,
  },
  ...
  },
  {
    ...
    wireId: "claude-opus-5.5",
    name: "Claude Opus 5.5 (medium) (2.0x)",
    contextLimit: getModelContextLimit("claude-opus-5-5"),
    outputLimit: 128000,
    rateMultiplier: 2,
    modalities: PDF_MODALITIES,
  },
  {
    ...
    wireId: "claude-opus-5.5",
    name: "Claude Opus 5.5 (high) (2.0x)",
    contextLimit: getModelContextLimit("claude-opus-5-5"),
    outputLimit: 128000,
    rateMultiplier: 2,
    modalities: PDF_MODALITIES,
  },
  {
    ...
    wireId: "claude-opus-5.5",
    name: "Claude Opus 5.5 (xhigh) (2.0x)",
    contextLimit: getModelContextLimit("claude-opus-5-5"),
    outputLimit: 128000,
    rateMultiplier: 2,
    modalities: PDF_MODALITIES,
  ...
  },
  {
    ...
    contextLimit: getModelContextLimit("deepseek-3.2"),
    outputLimit: 64000,
    modalities: IMAGE_MODALITIES,
  },
  {
    ...
    wireId: "glm-5",
    name: "GLM-5 (0.5x)",
    contextLimit: getModelContextLimit("glm-5"),
    outputLimit: 64000,
  ...
  },
  {
    ...
    contextLimit: getModelContextLimit("minimax-m2.5"),
    outputLimit: 64000,
    modalities: TEXT_MODALITIES,
  },
  {
    ...
    contextLimit: getModelContextLimit("minimax-m2.1"),
    outputLimit: 64000,
    modalities: IMAGE_MODALITIES,
  },
  {
    id: "qwen3-coder-next",
    wireId: "qwen3-coder-next",
    name: "Qwen3 Coder Next (0.05x)",
    contextLimit: getModelContextLimit("qwen3-coder-next"),
    outputLimit: 64000,
    modalities: IMAGE_MODALITIES,
  },
  {
    ...
    contextLimit: getModelContextLimit("gpt-5.6-sol"),
    outputLimit: 128000,
    modalities: IMAGE_MODALITIES,
  },
  {
  ...
  },
  {
    ...
    contextLimit: getModelContextLimit("gpt-5.6-terra"),
    outputLimit: 128000,
    modalities: IMAGE_MODALITIES,
  },
  {
  ...
  },
  {
    ...
    wireId: "gpt-5.6-terra",
    name: "GPT 5.6 Terra (medium) (1.0x)",
    contextLimit: getModelContextLimit("gpt-5.6-terra"),
    outputLimit: 128000,
    modalities: IMAGE_MODALITIES,
  },
  ...
  },
  {
    ...
    contextLimit: getModelContextLimit("gpt-5.6-luna"),
    outputLimit: 128000,
    modalities: IMAGE_MODALITIES,
  },
  {
